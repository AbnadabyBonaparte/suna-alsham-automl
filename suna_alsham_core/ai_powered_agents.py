...
def create_meta_cognitive_agents(message_bus) -> List[BaseNetworkAgent]:
    """
    Cria os agentes de Meta-Cognição de forma segura.
    """
    agents = []
    ...
    try:
        ...
        # Inicializa o loop meta-cognitivo sem bloquear a criação
        ...
        # Mesmo com erro, retorna a lista atual (possivelmente vazia) para não quebrar o agent_loader
    return agents
