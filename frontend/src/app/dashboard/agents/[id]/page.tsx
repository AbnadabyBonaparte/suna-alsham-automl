          ...
          <Card className="bg-surface/40 border-border/10 backdrop-blur-sm">
            ...
            <CardContent>
              ...
              <div className="w-full bg-background/50 h-2 rounded-full overflow-hidden">
                <div
                  className="h-full bg-gradient-to-r from-[var(--color-accent)] to-[var(--color-primary)] transition-all duration-1000"
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span
                  ...
                  style={{ color: agent.status === 'ACTIVE' ? 'var(--color-success)' : '#71717A' }}
                >
                  {agent.status}
                </span>
              </div>
        ...
        <div className="md:col-span-2 space-y-6">
          <Card className="bg-surface/40 border-border/10 backdrop-blur-sm h-full flex flex-col">
            ...
            <CardContent className="flex-1">
              <div
                className="bg-background/80 rounded-lg p-4 font-mono text-xs h-[400px] overflow-y-auto space-y-2 border border-border/5"
                style={{ color: 'var(--color-success)/80' }}
              >
                ...
                <p className="text-[var(--color-primary)] font-bold">
                  &gt; Current task: {agent.current_task || 'Awaiting orders'}
                </p>
                ...
                {Array.from({ length: 5 }).map((_, i) => (
                  <p key={i} className="opacity-70">
                    &gt; [{new Date().toISOString().split('T')[1].slice(0, -1)}] Processing chunk #
