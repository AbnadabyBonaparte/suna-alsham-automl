...
export default function EvolutionPage() {
  ...
  const handleAnalyzeAgent = async (agentId: string, agentName: string) => {
    ...
    try {
      ...
      if (data.success) {
        ...
        addNotification({
          type: 'success',
          title: `Proposta de evolução gerada para ${agentName}!`,
        });
      } else {
    ...
    try {
      ...
      if (data.success) {
        if (action === 'approve') {
          addNotification({
            type: 'success',
            title: `🧬 Agent ${currentProposal.agent_name} evoluído com sucesso!`,
          });
        } else {
          addNotification({
            type: 'info',
            title: `Proposta para ${currentProposal.agent_name} rejeitada`,
          });
        }
  ...
  return (
    <div className="h-[calc(100vh-6rem)] flex flex-col gap-6 p-2 overflow-hidden">
      {/* HEADER */}
      <PageHeader
        eyebrow="Auto-Evolução"
        title="Evolution"
        titleAccent="Lab"
        subtitle="Auto-evolução de agents orquestrada pelo motor ALSHAM."
        icon={Dna}
        actions={
          <button
            onClick={loadData}
            disabled={loading}
            className="q-chip transition hover:brightness-125 disabled:opacity-50"
                ...
                {candidates.length === 0 ? (
                  ...
                  >
                    ...
                    <p className="text-xl font-bold" style={{ color: colors.text }}>
                      Todos os agents estão saudáveis!
                    </p>
                    <p className="text-sm mt-2" style={{ color: colors.textSecondary }}>
                      Nenhum candidato para evolução identificado
                    </p>
                  </div>
                ) : (
                          ...
                          style={{
                            background:
                              candidate.recommendation === 'urgent'
                                ...
                                : `${colors.warning}/20`,
                            color:
                              candidate.recommendation === 'urgent' ? colors.error : colors.warning,
                      ...
                      <div className="grid grid-cols-3 gap-4 mb-4">
                        <div>
                          ...
                          <div
                            ...
                            style={{
                              color:
                                candidate.success_rate >= 75
                                  ? colors.success
                                  : candidate.success_rate >= 50
                                    ? colors.warning
                                    : colors.error,
                            }}
                          >
              ...
              <div className="space-y-3">
                {history.length === 0 ? (
                  ...
                  >
                    ...
                    <p className="text-xl font-bold" style={{ color: colors.text }}>
                      Nenhuma evolução aplicada ainda
                    </p>
                    <p className="text-sm mt-2" style={{ color: colors.textSecondary }}>
        ...
        >
          ...
          >
            ...
            <div
              ...
              style={{ borderBottom: `1px solid ${colors.border}/10` }}
            >
              ...
              >
                ...
                <div className="mb-4">
                  <span
                    ...
                    style={{
                      background:
                        currentProposal.analysis.confidence === 'high'
                          ? `${colors.success}/20`
                          : currentProposal.analysis.confidence === 'medium'
                            ? `${colors.warning}/20`
                            : `${colors.error}/20`,
                      color:
                        currentProposal.analysis.confidence === 'high'
                ...
                <div className="mb-4">
                  <div className="text-sm font-bold mb-2" style={{ color: colors.error }}>
                ...
                <div className="mb-4">
                  <div className="text-sm font-bold mb-2" style={{ color: colors.success }}>
                    ✅ Melhorias Propostas:
                  </div>
                  <ul
                    className="list-disc list-inside space-y-1 text-sm"
                ...
                {currentProposal.analysis.reasoning && (
                  <div className="mt-4 p-4 rounded-lg" style={{ background: `${colors.surface}` }}>
        ...
        >
          ...
          >
            ...
            <div className="text-xl font-bold" style={{ color: colors.text }}>
              IA ALSHAM está analisando...
            </div>
            <p className="text-sm" style={{ color: colors.textSecondary }}>
              Gerando proposta de evolução inteligente
            </p>
          </div>
        </div>
      )}
