...
export default function DashboardPage() {
  ...
  // Função de cor da barra de eficiência
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-white/10 pb-6 bg-black/20 backdrop-blur-sm sticky top-0 z-40">
          ...
          <div className="flex items-center gap-3">
            ...
            >
              ...
              {panicMode && <div className="absolute inset-0 bg-red-600 animate-ping opacity-75"></div>}
            </Button>
...
// Componentes auxiliares (mantidos exatamente como você tinha)
